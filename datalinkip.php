                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <table class="table  ">
                            ...
                            <tr>
                              <td colspan="2"><span class="text-danger">* </span><input type="text" value="<?php echo kirim($linked); ?>" id="myInput" readonly class="form-control">
                              <br>
                              <button onclick="myFunction()" class="btn btn-light "><i style="font-size:18px" class="fa">&#xf24d;</i> Copy Link</button></td>
                            </tr>
                            <tr>
                              <td colspan="2">
                              <div class="card">

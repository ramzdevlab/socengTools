...
$token = '06e6a9519d7747df644cc54cf273ec1491cc2a3e';
...
if(isset($_POST['title'],$_POST['desc'])){
    ...
    $link = "https://$_SERVER[HTTP_HOST]/ramztool/hayolu.php?id=".$ids;
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
       <form action="" method="POST">
             ...
             <input type="hidden" name="jenis" value="linkip">
  ...
  <table class="table text-center table-responsive w-100" >
      ...
      <?php
      $author = $_SESSION['username'];
      $query = mysqli_query($koneksi, "SELECT * FROM links WHERE author = '$author' && jenis ='linkip'");
      $x = 1;
      while($data = mysqli_fetch_array($query)){
          $idd = $data['ids'];
          $linked = $data['link'];
          $sqlmap = mysqli_query($koneksi, "SELECT * FROM locat WHERE ids = '$idd'");
          $short = $bitly->shorten($linked);
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body text-left">
                        ...
                        <table class="table  ">
                            ...
                            <tr>
                              <td colspan="2"><span class="text-danger">* </span><input type="text" value="<?php echo $short; ?>" id="myInput" readonly class="form-control"><br><button onclick="myFunction()" class="btn btn-light "><i style="font-size:18px" class="fa">&#xf24d;</i> Copy Link</button></td>
                            </tr>
                            <tr>
                              <td colspan="2">
                              <div class="card">
                                <div class="card-body">
                                <span class="text-danger">* </span> Sebarkan link ini hanya kepada target yang anda tuju!
                                  dan pastikan target mengklik link tersebut.
                                </div>
                              </div>
                              </td>
                            </tr>

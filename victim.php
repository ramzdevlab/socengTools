...
<h4 class="mb-3"><i style="font-size:24px" class="fa">&#xf0c0;</i> Data Victim Lokasi</h4>
  <?php
  if(isset($_POST['id'], $_POST['ket'])){
    if($_POST['ket'] == "loc"){
      $id = addslashes($_POST['id']);
      $sql = mysqli_query($koneksi, "DELETE FROM locat WHERE id = '$id'");
      if($sql){
        ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
          <strong>Berhasil!</strong> 1 data victim telah terhapus!
        ...
        ?>
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Gagal!</strong> data gagal terhapus!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
  ...
  ?>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form action="" method="post">
                    ...
                    <input type="hidden" name="ket" value="loc">
    ...
    <?php
      if(isset($_POST['id'], $_POST['ket'])){
        if($_POST['ket'] == "cam"){
          $id = addslashes($_POST['id']);
          $sql = mysqli_query($koneksi, "DELETE FROM camera WHERE id = '$id'");
          if($sql){
            ?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
              <strong>Berhasil!</strong> 1 data victim telah terhapus!
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <form action="" method="post">
                      <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                      <input type="hidden" name="ket" value="cam">
                      <button type="submit" class="btn btn-danger">Hapus</button>
                  </form>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                </div>

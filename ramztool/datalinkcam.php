...
if(isset($_POST['title'],$_POST['desc'])){
    ...
    $link = "https://$_SERVER[HTTP_HOST]/ramztool/apaan.php?ids=".$ids;
    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
       <form action="" method="POST">
             ...
             <input type="hidden" name="jenis" value="linkcam">
...
<div class="table-responsive">
  <table class="table text-center  w-100" >
      ...
      <?php
      $author = $_SESSION['username'];
      $query = mysqli_query($koneksi, "SELECT * FROM links WHERE author = '$author' && jenis ='linkcam'");
      $x = 1;
